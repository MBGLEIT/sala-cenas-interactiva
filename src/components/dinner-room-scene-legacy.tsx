...
import DinnerRoomPlan2DLegacy from "@/components/dinner-room-plan-2d-legacy";
import DinnerRoomTable3DLegacy from "@/components/dinner-room-table-3d-legacy";
...
type DinnerRoomSceneLegacyProps = {
  evento: EventoSala;
...
function SceneContent(props: DinnerRoomSceneLegacyProps) {
...
export default function DinnerRoomSceneLegacy(props: DinnerRoomSceneLegacyProps) {
